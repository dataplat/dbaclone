...
$importIndividualFiles = Get-PSFConfigValue -FullName PSDatabaseClone.Import.IndividualFiles -Fallback $false
if ($PSDatabaseClone_importIndividualFiles) { $importIndividualFiles = $true }
